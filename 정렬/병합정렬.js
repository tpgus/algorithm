//병합을 담당하는 함수 Solution 1 : 각각 정렬된 두 개의 배열을 인수로 취한다.
//병합 정렬에서 최초로 병합 함수를 호출할 때에는 배열의 길이가 0 또는 1이다 즉, 이미 정렬되어 있다.
//이미 정렬된 배열들을 가지고 병합 함수를 호출하는 것이다.
//병합 정렬의 시간 복잡도는 O(N * log N)인데, 앞의 N은 병합하는 함수에 대한 시간 복잡도이다.
...
//병합을 담당하는 함수 Solution 2 : 각각 정렬된 두 개의 배열을 인수로 취한다
